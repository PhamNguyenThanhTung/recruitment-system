// File: app/(dashboard)/admin-jobs/new/JobForm.tsx
"use client";
        ...
        <div className="lg:col-span-4 space-y-8">
          <div className="bg-primary-container p-8 rounded-xl text-on-primary relative overflow-hidden shadow-lg">
            <div className="relative z-10">
              <span className="bg-white/20 text-white text-[10px] font-bold tracking-widest px-2 py-1 rounded mb-4 inline-block uppercase backdrop-blur-sm">Live Preview</span>
              <div className="flex items-center gap-4 mb-4">
                <div className="w-14 h-14 bg-white rounded-xl shadow flex items-center justify-center shrink-0 overflow-hidden">
                  {previewLogoUrl ? (
                    ...
                    <span className="text-primary font-bold text-2xl">{previewCompany ? previewCompany.charAt(0).toUpperCase() : "?"}</span>
                  )}
                </div>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                <span className="bg-white/20 px-3 py-1 rounded-full text-xs font-medium backdrop-blur-md">Đang mở tuyển</span>
                <span className="bg-white/20 px-3 py-1 rounded-full text-xs font-medium backdrop-blur-md truncate max-w-full">{previewSalary || "Mức lương"}</span>
              </div>
